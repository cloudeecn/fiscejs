...
function FiScEContext() {
	...
	/** Special types* */
	this.TOP_CLASS=new FiScEClass();
	this.TOP_THROWABLE=new FiScEClass();
	this.TOP_ENUM=new FiScEClass();
	this.TOP_ANNOTATION=new FiScEClass();
	this.TOP_SOFT_REF=new FiScEClass();
	this.TOP_WEAK_REF=new FiScEClass();
	this.TOP_PHANTOM_REF=new FiScEClass();
}
