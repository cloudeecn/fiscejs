		...
		__fy_outer: while (true) {
			try {
				...
				case 48:
					// ##OP-D2L -2 2
					ops--;
					FyPortable.doubleToLong(FyPortable.ieee64ToDouble(stack,
							sp - 2), stack, sp - 2);
					// ###
				case 49:
					// ##OP-DADD -4 2
					...
					FyPortable.doubleToIeee64(FyPortable.ieee64ToDouble(stack,
							sp - 2)
							+ FyPortable.ieee64ToDouble(stack, sp), stack,
							sp - 2);
					// ###
				case 50:
				...
				case 52:
					...
					stack[sp - 1] = FyPortable.dcmpg(FyPortable.ieee64ToDouble(
							stack, sp - 1), FyPortable.ieee64ToDouble(stack,
							sp + 1));
					// ###
				case 53:
					// ##OP-DCMPL -4 1
				...
				case 68:
					...
					ops--;
					FyPortable
							.doubleToIeee64(floatStack[sp - 1], stack, sp - 1);
					sp++;
					// ###
				case 69:
					// ##OP-F2I -1 1
				...
				case 130:
					...
					if ((clazz.accessFlags & FyConst.FY_ACC_SUPER)
							&& context.classLoader.isSuperClassOf(tmpClass,
									clazz)
				...
				case 178:
					...
					sp--;
					stack[sp - 1] = heap
							.getArrayShort(stack[sp - 1], stack[sp]);
					// ###
				case 179:
					// ##OP-SASTORE -3 0
					lip = $ip;
